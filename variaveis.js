...
console.log("Uma variável declarada com o var tem o escopo global no código, e uma variável declarada com let possui um escopo de bloco")
...
let texto = `Eu estudo na faculdade ${faculdade}`
console.log(texto)
